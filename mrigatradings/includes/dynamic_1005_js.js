...
function guestMemValid (objfrm) {
	...
	if(reg.test(objfrm.username.value) == false) {
    ...
    if(!isValid(objfrm.address))
   	...
   	if ((objfrm.country.options[objfrm.country.selectedIndex].value=="IN^91") && (objfrm.state_code1.options[objfrm.state_code1.selectedIndex].value=="")) {
	     
    	alert("Please Select Your State Name");
    	objfrm.state_code1.focus();
    	return false;
 	}
   	     	 			
	if(objfrm.ph_number.value=="Phone No" && objfrm.mobile_phone.value=="Mobile No") {
		
		alert('Please Enter Your Phone / Mobile Number.');
		objfrm.ph_number.focus();
     	return false;
	 }
	 else if(objfrm.ph_number.value!="Phone No") {
		 
		if (chktrim(objfrm.ph_ccode.value).length==0 || chktrim(objfrm.ph_ccode.value)=='ISD Code') {
			
			alert("Enter Your ISD Code ");
         	objfrm.ph_ccode.focus();
			return false;
  	    }
      	if (chktrim(objfrm.ph_acode.value).length==0 || chktrim(objfrm.ph_acode.value)=='STD Code') {
	      	
			alert("Enter Your STD Code ");
         	objfrm.ph_acode.focus();
         	return false;
      	}
      	if (chktrim(objfrm.ph_number.value).length==0 || chktrim(objfrm.ph_number.value)=='Phone No') {
...
function chk_joinguestnow1(chk1) { // validation on join now second page(first half).somesh    
    ...
    if(chktrim(chk1.ph_number.value)=="Phone No." && chktrim(chk1.mobile_phone.value)=="Mobile No.")
		{
				alert('Please Enter Your Phone / Mobile Number(s).');
				chk1.ph_number.focus();
			 	return false;
		}
		else if(chktrim(chk1.ph_number.value)!="Phone No.")
		{
		    if (chktrim(chk1.ph_ccode.value).length ==0 || chk1.ph_ccode.value=='ISD Code')
		    {
			   alert("Enter ISD Code");
			   chk1.ph_ccode.focus();
			   return false;
		   }
		   if (chktrim(chk1.ph_acode.value).length ==0 || chk1.ph_acode.value=='STD Code')
		    {
...
i.height;j.fadeTo(d.changeFade,0.3,function(){var g=function(){j.html(m.contents()).fadeTo(d.changeFade,1,S)};b.event.trigger("fancybox-change");j.empty().removeAttr("filter").css({width:i.width-d.padding*2,height:e.autoDimensions?"auto":i.height-y-d.padding*2});if(c)g();else{B.prop=0;b(B).animate({prop:1},{duration:d.changeSpeed,easing:d.easingChange,step:T,complete:g})}})}else{f.removeAttr("style");if(d.transitionIn=="elastic"){r=V();j.html(m.contents());
...
b(B).animate({prop:0},{duration:d.speedOut,easing:d.easingOut,step:T,complete:a})}else f.fadeOut(d.transitionOut=="none"?0:d.speedOut,a)}}};b.fancybox.resize=function(){u.is(":visible")&&u.css("height",b(document).height());b.fancybox.center(true)};b.fancybox.center=function(a){var c,g;if(!h){g=a===true?1:0;c=U();!g&&(f.width()>c[0]||f.height()>c[1])||f.stop().animate({top:parseInt(Math.max(c[3]-20,c[3]+(c[1]-j.height()-40)*0.5-d.padding)),left:parseInt(Math.max(c[2]-20,c[2]+(c[0]-j.width()-40)*0.5-d.padding))},typeof a=="number"?a:200)}};b.fancybox.init=function(){if(!b("#fancybox-wrap").length){b("body").append(m=b('<div id="fancybox-tmp"></div>'),t=b('<div id="fancybox-loading"><div></div></div>'),u=b('<div id="fancybox-overlay"></div>'),f=b('<div id="fancybox-wrap"></div>'));D=b('<div id="fancybox-outer"></div>').appendTo(f);f.append(j=b('<div id="fancybox-content"></div>'),		E=b('<a id="fancybox-close"></a>'),n=b('<div id="fancybox-title"></div>'),z=b('<a href="javascript:;" id="fancybox-left"><span class="fancy-ico" id="fancybox-left-ico"></span></a>'),A=b('<a href="javascript:;" id="fancybox-right"><span class="fancy-ico" id="fancybox-right-ico"></span></a>'));E.click(b.fancybox.close);t.click(b.fancybox.cancel);z.click(function(a){a.preventDefault();b.fancybox.prev()});A.click(function(a){a.preventDefault();b.fancybox.next()});b.fn.mousewheel&&f.bind("mousewheel.fb",function(a,c){if(h)a.preventDefault();else if(b(a.target).get(0).clientHeight==0||b(a.target).get(0).scrollHeight===b(a.target).get(0).clientHeight){a.preventDefault();b.fancybox[c>0?"prev":"next"]()}});b.support.opacity||f.addClass("fancybox-ie");if(M){t.addClass("fancybox-ie6");f.addClass("fancybox-ie6");b('<iframe id="fancybox-hide-sel-frame" src="'+(/^https/i.test(window.location.href||"")?"javascript:void(false)":"about:blank")+'" scrolling="no" border="0" frameborder="0" tabindex="-1"></iframe>').prependTo(D)}}};b.fn.fancybox.defaults={padding:1,margin:0,opacity:false,modal:false,cyclic:false,scrolling:"auto",width:560,height:340,autoScale:true,autoDimensions:true,centerOnScroll:true,ajax:{},swf:{wmode:"transparent"},hideOnOverlayClick:false,hideOnContentClick:false,overlayShow:true,overlayOpacity:0.255,overlayColor:"#777",titleShow:true,titlePosition:"float",titleFormat:null,titleFromAlt:false,transitionIn:"fade",transitionOut:"fade",speedIn:300,speedOut:300,changeSpeed:300,changeFade:"fast",easingIn:"swing",easingOut:"swing",showCloseButton:true,showNavArrows:true,enableEscapeButton:true,enableKeyboardNav:true,onStart:function(){},onCancel:function(){},onComplete:function(){},onCleanup:function(){},onClosed:function(){},onError:function(){}};b(document).ready(function(){b.fancybox.init()})})(jQuery);(function($){
