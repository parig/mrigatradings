...
<head>
    ...
    <title>Services | Mriga Tradings</title>
...
<div class="col-sm-12">    			   			
					<h2 class="title text-center">Services</h2>
                     <p style="float:left;"><img src="images/services.jpg" align="left" /></p>   
                    <div style="font-size:14px; font-weight:300; color:#000; padding:30px; text-align:justify;">
                        			    				    				
					<p>We import the highest quality of fresh vegetables and fruits across the globe. Currently We are  suppling in Singapore market and in due time will be extending our services to the global market.</p>
                    <p>Our field officers are currently working at indian locations to do the necessary quality checks and  monitor the suppliers logitics to
enable the shipments on time.  We have enabled the global logistics to supply the fresh vegetables and fruits to other countries.</p>
<p>Have dedicated transport services to supply the goods to our customers on time without any additional cost in singapore.</p>
<p>We will extend our presence in the asean market in the next financial year. Our team is committed and dedicated.</p>
 </div>
<p>&nbsp;</p>
				</div>            
