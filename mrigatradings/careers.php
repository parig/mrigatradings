...
<head>
    ...
    <title>Careers | Mriga Tradings</title>
...
<div class="col-sm-12">    			   			
					...
					<p style="float:right;"><img src="images/home/careers-mriga.jpg" width="406" height="296"><br>Please send your updated your resume to <a href="mailto:hr@mrigatradings.com.sg">hr@mrigatradings.com.sg</a></p>
                    
                    <p>Our Singapore operation requires very dyamic, creative and forward thinking young talents.
Currently we have the following opportunities in singapore location:</p>
                    <p>
                    <h3 style="font-size:18px;">Sales Executive</h3>
                    <ul class="content_1">
                    <li>Number of position : 2</li>
                    <li>Minimum acadamic qualification : A' Level, Degree Certification</li>
                    </ul>
                    
                    <h3 style="font-size:18px;">Class 3, 4 Driver</h3>
                    <ul class="content_1">
                    <li>Number of position : 1</li>
                    <li>Minimum acadamic qualification : N' Level or More</li>
                    </ul>
                    <h3 style="font-size:18px;">Admin Incharge</h3>
                    <ul class="content_1">
                    <li>Number of position : 1</li>
                    <li>Minimum acadamic qualification : Any Degree Certification</li>
                    </ul> 
                    <h3 style="font-size:18px;">Customer Support</h3>
                    <ul class="content_1">
                    <li>Number of position : 2</li>
                    <li>Minimum acadamic qualification : A' Level, Degree Certification</li>
                    </ul>                                                            
