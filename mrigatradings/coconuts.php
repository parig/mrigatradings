...
<head>
    ...
    <title>Coconuts | Mriga Tradings</title>
							...
							<ul class="nav navbar-nav collapse navbar-collapse">
                                ...
                                <li class="dropdown"><a href="javascript:void(0)">Company</a>
                                    <ul role="menu" class="sub-menu">
                                        <li><a href="our-history.php" >Our History</a></li>                                       										 										<li><a href="core-values.html">Core Values</a></li> 
                                    </ul>
                                </li>                                  	
                                <li><a href="services.html">Services</a></li>
                                
								<li class="dropdown"><a href="javascript:void(0)" class="active">Products<i class="fa fa-angle-down"></i></a>
                                    <ul role="menu" class="sub-menu">
                                        <li class="dropdown dropdown-submenu"><a href="javascript:void(0)" class="dropdown-toggle" data-toggle="dropdown">Fruits</a>
                                            <ul class="dropdown-menu">
                                                ...
                                                <li><a href="coconuts.php">Coconuts</a></li>  
                                        ...
                                        <li class="dropdown dropdown-submenu"><a href="javascript:void(0)" class="dropdown-toggle" data-toggle="dropdown">Vegetables</a>
                                            <ul class="dropdown-menu">
                                                <li><a href="javascript:void(0)">Tomatoes</a></li>
                                                <li><a href="javascript:void(0)">Potatoes</a></li>  
                                                <li><a href="javascript:void(0)">Lemon</a></li>                                  
                                                <li><a href="javascript:void(0)">Onions</a></li>
                                                <li><a href="javascript:void(0)">Capsicum</a></li>
                                                <li><a href="javascript:void(0)">Carrots</a></li>
                                                <li><a href="javascript:void(0)">Garlic Cloves</a></li>
                                                <li><a href="javascript:void(0)">Peas</a></li>
                                                <li><a href="javascript:void(0)">Drumsticks</a></li>
                                                <li><a href="javascript:void(0)">Beetroot</a></li>
                                                <li><a href="javascript:void(0)">Ginger</a></li>
                                            </ul>
                                        </li>                                         
                                                                             
                                    </ul>  
                                 </li>  
                                <li class="dropdown"><a href="javascript:void(0)">Enquiry</a>
                                    <ul role="menu" class="sub-menu">
                                        <li><a href="buying-request.php" >Buying Request</a></li>                                       										 										<li><a href="supplier-quotation.php">Supplier Quotation</a></li> 
                                    </ul>
                                </li>   
...
<!--						<div class="" > 
							<img src="images/home/samplead.jpg" alt="" />
						</div> 		-->				
				...
				<div class="col-sm-9 padding-right">
					<div class="features_items"><!--features_items-->
						<h2 class="title text-center">Coconuts</h2>
                        		<ul class="breadcrumb">
			<li><a href="index.php">Home</a></li>
		 
			<li><a href="javascript:void(0)">Coconuts</a></li>
		</ul> 
						<div class="col-sm-4">
